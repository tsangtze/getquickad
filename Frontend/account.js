(() => {
  ...
  function emailLinkMessage() {
    return emailLinkFailed
      ...
      : accountText("account.email_link_returned", "You returned from an email link. Sign in with your Pix2Vid password. Invited users who have not set a password need a password-setup flow.");
  }
  ...
  function setMode(signup) {
    ...
    note.textContent = signup
      ? accountText("account.note_signup", "Choose a unique Pix2Vid password of at least 8 characters. Confirm your email, then return here to sign in.")
      : accountText("account.note_signin", "Use your Pix2Vid password, not your Gmail password. Signing in reloads this page and discards unsaved edits.");
  }
