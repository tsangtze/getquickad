...
// Production default is 10; Render may override this for controlled testing.
export const FREE_VIDEO_PLANS =
  Number.parseInt(process.env.FREE_VIDEO_PLANS || "10", 10);
